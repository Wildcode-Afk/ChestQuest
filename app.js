/* ============================================================
   ...
   chess-rules.js.
   Évaluation, sélection de coups, recherche minimax et niveaux
   de difficulté (VALUE, evalMove, chooseAIMove, orderMoves,
   materialEval, negamax, chooseAIMoveMinimax, eloTierLabel,
   aiParamsForElo, chooseAIMoveForElo) : chess-ai.js.
   (les trois chargés avant ce fichier)
   Ce fichier contient le contenu (leçons/puzzles) et l'interface.
   ============================================================ */

// VALUE, evalMove, chooseAIMove, orderMoves, materialEval, negamax,
// chooseAIMoveMinimax : voir chess-ai.js
...
// eloTierLabel, aiParamsForElo, chooseAIMoveForElo : voir chess-ai.js
